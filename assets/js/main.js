...
/*===== MENU SHOW =====*/
/*Ao clicar, sobe o menu*/
if(navToggle){
    navToggle.addEventListener('click', function(){
        return navMenu.classList.add('show-menu')
    })
}
/*===== MENU HIDDEN =====*/
/*Ao clicar, esconde o menu*/
if(navClose){
    navClose.addEventListener('click', function(){
        return navMenu.classList.remove('show-menu')
    })
}
...
const discordIcon = document.getElementById('discord-icon'), 
      discordText = document.getElementById('discord-icon-text'),
      discordLink = document.getElementById('discord-icon-link')


if(discordIcon){
    discordIcon.addEventListener('click', function(){
        return discordText.classList.add('span__discord-clicked')
    })
}
